...
(lib.Symbol33 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(84.6,4.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AgygqIAQgOIBVBjIgQAPg");
	this.shape_1.setTransform(84.6,-4.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgsBDIAAiFIBZAAIAAAMIhLAAIAAAtIA0AAIAAAJIg0AAIAAA4IBLAAIAAALg");
	this.shape_2.setTransform(65.3,1.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AhBBDIAAiFIAOAAIAAB6IAuAAIAAh6IAMAAIAAB6IAuAAIAAh6IANAAIAACFg");
	this.shape_3.setTransform(50.5,1.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFFFF").s().p("AgwBDIAAiFIAOAAIAAA5IAwAAQATAAAJAJQAHAKAAATQAAAmghAAgAgiA4IAyAAQASAAAAgbQAAgdgTAAIgxAAg");
	this.shape_4.setTransform(36.2,1.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AAoBDIAAh5Ig1AAQgDA7gWA+IgPAAQAYhHADg+IBQAAIAACFg");
	this.shape_5.setTransform(22.2,1.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("AgsA3QgPgPAAgoQAAgnAPgPQAOgPAeAAQAfAAAOAPQAPAPAAAnQAAAngPAQQgOAPgfAAQgfAAgNgPgAgiguQgKAMAAAiQAAAiAKAMQAJAMAZAAQAaAAAJgMQAKgMAAgiQAAgigKgMQgJgLgaAAQgZAAgJALg");
	this.shape_6.setTransform(9.1,1.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#FFFFFF").s().p("AgwBDIAAiFIBTAAIAAAMIhFAAIAAAtIAwAAQATAAAJAJQAHAKAAATQAAAmghAAgAgiA4IAyAAQASAAAAgbQAAgdgTAAIgxAAg");
	this.shape_7.setTransform(-4.5,1.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#FFFFFF").s().p("AgwBDIAAiFIAOAAIAAA5IAwAAQATAAAJAJQAHAKAAATQAAAmghAAgAgiA4IAyAAQASAAAAgbQAAgdgTAAIgxAAg");
	this.shape_8.setTransform(-22.8,1.1);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#FFFFFF").s().p("AgFBDIAAh5IguAAIAAgMIBnAAIAAAMIguAAIAAB5g");
	this.shape_9.setTransform(-35.4,1.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AAtBDIgPgqIg/AAIgNAqIgOAAQAXhEAbhBIAWAAQAbBSAWAzgAAZAOQgQgtgHgYIgDAAIgbBFIA1AAIAAAAg");
	this.shape_10.setTransform(-46.1,1.1);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AAjBDIAAhCIhFAAIAABCIgNAAIAAiFIANAAIAAA4IBFAAIAAg4IANAAIAACFg");
	this.shape_11.setTransform(-59.6,1.1);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgvBAIAEgLQARAFAWAAQAUAAAIgGQAJgHAAgPQAAgQgIgHQgIgGgRAAIgTAAIAAgKIATAAQAQAAAHgGQAGgFAAgOQAAgNgGgFQgIgFgTAAQgWAAgQAFIgEgMQAcgFAOAAQAYAAAMAJQAMAHAAARQAAAOgFAIQgHAJgPACQAeABAAAgQABAWgOAJQgNAJgZAAQgXAAgUgGg");
	this.shape_12.setTransform(-72.2,1.1);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AgbBDQAMgQAJgRQgGgTgOgdQgOgfgMgVIAQAAQAZAyAMAkQAeg8AIgaIAPAAQgfBMgiA5g");
	this.shape_13.setTransform(-84.3,1.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-89.7,-10.3,179.4,20.6);
...
(lib.Symbol32 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.b1 = new lib.Symbol34();

	this.b2 = new lib.Symbol33();
	this.b2.setTransform(0.7,-0.6);
...
(lib.Symbol13 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(0,0,1,1.053,0,18.3,0);
...
p.nominalBounds = new cjs.Rectangle(-183,-328,370,672);
...
(lib.sc1 = function(mode,startPosition,loop) {
	...
	this.l1.setTransform(0,-87.8);

	this.t3 = new lib.Symbol3();
	this.t3.setTransform(0,-62.8);

	this.t2 = new lib.Symbol2();
	this.t2.setTransform(0,-110.3);

	this.t1 = new lib.Symbol1();
	this.t1.setTransform(2.2,-140.7,1,1,0,0,0,0,9.1);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		tl.to(r.blk, 0.5, {alpha:0, ease:Power0.easeNone}, 0.0)
		  .from(r.sc1.packs, 1.4, {y:"+=400", ease:Expo.easeOut}, 0.0)
		  .from(r.sc1.circ, 1.4, {scaleX:0, scaleY:0, ease:Elastic.easeOut.config(0.8,0.4)}, 0.7)
		  .staggerFrom([r.sc1.t1, r.sc1.t2, r.sc1.t3, r.sc1.l1], 0.8, {scaleX:0, scaleY:0, ease:Expo.easeOut}, 0.17, 1.0)
		  
		  
		  //2
		  .from(r.sc2.pic1, 1.2, {scaleX:3, scaleY:3, alpha:0, ease:Expo.easeOut}, time2)
		  .from(r.sc2.pic1.mc, 5, {scaleX:1.2, scaleY:1.2, ease:Power0.easeNone}, time2)
		  
		  .from(r.sc2.grad, 0.8, {x:"-=400", ease:Expo.easeOut}, time2+0.8)
		  .from(r.sc2.grad.mc, 1.0, {scaleX:0, ease:Expo.easeInOut}, time2+1.0)
		  .from(r.sc2.tri, 0.8, {/*y:"+=100", */scaleX:3, scaleY:3, alpha:0, ease:Expo.easeOut}, time2+1.6)
		  .staggerFrom([r.sc2.t1.t1, r.sc2.t1.t2, r.sc2.t1.t3], 0.8, {y:"+=300", ease:Expo.easeOut}, 0.07, time2+1.6)
		  
		  
		  //3
		  .from(r.sc2.pic2, 1.2, {scaleX:3, scaleY:3, alpha:0, ease:Expo.easeOut}, time3)
		  .from(r.sc2.pic2.mc, 5, {scaleX:1.2, scaleY:1.2, ease:Power0.easeNone}, time3)
		  .to(r.sc2.tri, 0.4, {/*y:"+=100", */scaleX:0, scaleY:0, ease:Expo.easeIn}, time3-0.3)
		  .staggerTo([r.sc2.t1.t1, r.sc2.t1.t2, r.sc2.t1.t3], 0.4, {x:"+=300", ease:Expo.easeIn}, -0.07, time3-0.3)
		  .from(r.sc2.dva, 0.8, {/*y:"+=100", */scaleX:3, scaleY:3, alpha:0, ease:Expo.easeOut}, time3+0.0)
		  .staggerFrom([r.sc2.t2.t1, r.sc2.t2.t2, r.sc2.t2.t3], 0.8, {y:"+=300", ease:Expo.easeOut}, 0.07, time3+0.0)
		  
		  //4
		  .from(r.sc2.pic3, 1.2, {scaleX:3, scaleY:3, alpha:0, ease:Expo.easeOut}, time4)
		  .from(r.sc2.pic3.mc, 5, {scaleX:1.2, scaleY:1.2, ease:Power0.easeNone}, time4)
		  .to(r.sc2.dva, 0.4, {/*y:"+=100", */scaleX:0, scaleY:0, ease:Expo.easeIn}, time4-0.3)
		  .staggerTo([r.sc2.t2.t1, r.sc2.t2.t2, r.sc2.t2.t3], 0.4, {x:"+=300", ease:Expo.easeIn}, -0.07, time4-0.3)
		  .from(r.sc2.odin, 0.8, {/*y:"+=100", */scaleX:3, scaleY:3, alpha:0, ease:Expo.easeOut}, time4+0.0)
		  .staggerFrom([r.sc2.t3.t1, r.sc2.t3.t2, r.sc2.t3.t3], 0.8, {y:"+=300", ease:Expo.easeOut}, 0.07, time4+0.0)
		  
		  
		  //5
		  .from(r.sc3.bg, 1.2, {scaleX:3, scaleY:3, alpha:0, ease:Expo.easeOut}, time5)
		  .from(r.sc3.bg.mc, 7.8, {scaleX:1.1, scaleY:1.1, ease:Power0.easeNone}, time5)
		  .from(r.sc3.lab, 0.8, {x:"+=200", alpha:0, ease:Expo.easeOut}, time5+0.6)
		  .staggerFrom([r.sc3.t1, r.sc3.t2, r.sc3.t3], 1.2, {y:"+=100", alpha:0, ease:Expo.easeOut}, 0.03, time5+0.8)
		  .from(r.sc3.hash, 1.2, {x:"+=70", alpha:0, ease:Expo.easeOut}, time5+1.0)
		  .staggerFrom([r.sc3.btn.b1, r.sc3.btn.b2], 1.2, {scaleX:0, scaleY:0, ease:Elastic.easeOut.config(0.8,0.4)}, 0.03, time5+1.2)
		  
		  .call(replay)
		  .to(this.blk, 0.9, {alpha:1, ease:Power0.easeNone, onComplete:restart}, time5+7)
		  ;
