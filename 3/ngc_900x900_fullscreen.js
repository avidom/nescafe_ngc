...
p.nominalBounds = new cjs.Rectangle(0,0,1800,1800);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.setTransform(-900,-900);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-2617.9,-3823.8,4103.7,4723.8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.blk.setTransform(0,0,2.645,2.644);
...
p.nominalBounds = new cjs.Rectangle(-2617.9,-3823.8,4103.7,5013.8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		function onResize() {
		 ...
		 //
		 scaleNew = newWidth / newHeight;
		 if (scaleNew>1)
			 {scale=1.0}
			 else { scale=scaleNew * 2 }
		 console.log("newWidth="+newWidth);
		 console.log("newHeight="+newHeight);
		 console.log("scale="+scale);
		 console.log("scaleNew="+scaleNew);
		 TweenMax.set(u.mcMain, {scaleX:scale, scaleY:scale});
	...
	// movie
	this.mcMain = new lib.content();
	this.mcMain.setTransform(900,900);

	this.timeline.addTween(cjs.Tween.get(this.mcMain).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-817.9,-2023.8,4350.5,5013.8);
